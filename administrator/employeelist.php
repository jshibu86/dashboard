                   ...
                   include_once "../model/department.php";
                    $department = new Department($connect);
                     if(isset($data['departmentid'])){
                      ...
                      $dp_data = $department->getDepartment($id);
                      if(isset($dp_data)){
                        echo $dp_data['departmentname'];
                      }
                     } else{
                      echo "NA";
                     } 
                    ...
                    <td>
                    <input type="checkbox" class="toggle-class" <?php if ($data['status'] == 1) echo "checked"; ?>
                     data-toggle="toggle" data-onstyle="success" data-size="sm" data-on="active"
                    ...
                    <td><div class="btn-group btn-group-sm">
                     ...
                     <div class="btn-group btn-group-sm" >
                       ...
                       <a href="employeeview.php?id=<?php echo $data['id']?>" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i></a>
