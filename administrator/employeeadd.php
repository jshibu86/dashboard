...
$department_data=$department->selectData();
if($department_data->rowCount())

{
    $department=[];
    while($row = $department_data->fetch(PDO::FETCH_OBJ))
    {
        $department[$row->id]=[
            'id'=>$row->id,
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              {
                ?>
              <form id="quickForm" action="../routes/updateemployee.php" enctype="multipart/form-data" method="post"> 
              <input type="hidden" name="empid" value=<?php echo $id?>/>
                <?php
              }
              else{
                ?>
                <form id="quickForm" action="../routes/addemployee.php" enctype=multipart/form-data method="post">
                <?php
              }
              ...
              ?>
                ...
                <div class="card-body">
                <div class="imageinput1 form-group">
                        <label for="imag">Image*</label><br>
                          <input type="file" multiple="false"  id="imag" name="image" title=" " class="input-img" 
                           
                          value="
                            <?php 
                             if(isset($_SESSION['oldimage']))
                             {
                                 echo $_SESSION['oldimage'];
                                 unset($_SESSION['oldimage']);
                             }
   
                            $value =(isset($employee_data['image']) ?  $employee_data['image'] : '');
                            echo $value;
                            ?>"><br>
                           <img id="uploadedImage" src="<?php if(isset($employee_data['image'])) {
                            $target_file ='../MyUploadImages/'.$employee_data['image']; 
                            echo $target_file;} ?>" alt="Uploaded Image" class="mt-2" accept=".png, .jpg, .jpeg" style="height:100px; width:100px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputName" placeholder="Enter Employee Name" value="<?php 
                  ...
                  <div class="form-group">
                    ...
                    <?php if(isset($_SESSION['oldemail']))
                          {
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" name="phonenumber" class="form-control" id="exampleInputPhone" placeholder="Enter PhoneNumber"
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="dob" class="form-control" id="exampleInputDob" placeholder="Enter Date"  
                    value="<?php if(isset($_SESSION['olddob']))
                          {
                  ...
                  <select
                    ...
                    if(isset($department))
                    {
                    foreach($department as $dpid => $data)
                    {
                      ...
                      ?>
                            ...
                            ?>"
                            <?php
                            if(isset($employee_data['departmentid'])){
                              if($data['id']==$employee_data['departmentid']){
                                echo "selected";
                              }
                            }
                             ?>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary float-right" name="submit"><?php $val=(isset($id)) ? 'Update' : 'Submit'; echo $val; ?></button>
                </div>
              </form>
            </div>
            <!-- /.card -->
