 ...
 <nav class="mt-2">
        ...
        <li class="nav-item
          ...
          <li class="nav-item
            ...
            ?>
          ">
            <a href="employeeselect.php" class="nav-link">
          ...
          <li class="nav-item
          <?php if($arr[0]=="departmentadd" || $arr[0]=="departmentlist")
                {
                  ?>
                  menu-open
                  <?php
          ...
          ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="departmentadd.php" class="nav-link 
                <?php if($arr[0]=="departmentadd")
                  {
                    ?>
                    active
                    <?php
